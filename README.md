...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-28 12:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/db32aa23-e1dd-4bfb-b91e-f9aca9adc718.git
$ cd db32aa23-e1dd-4bfb-b91e-f9aca9adc718
```
